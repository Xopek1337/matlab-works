...
[distDiff1, distDiff2] = calcTDoA(towers_X, towers_Y, users_X(1), users_Y(1));
...
function [distDiff1, distDiff2] = calcTDoA(towers_coord_X, towers_coord_Y, user_coord_x, user_coord_y)
